...
class SettingController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		if(isset($_POST['ProjectSetting'])) {
			$model->attributes=$_POST['ProjectSetting'];
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							'type' => 0,
							'msg' => '<div class="errorSummary success"><strong>Project Setting success updated.</strong></div>',
						));
					} else {
	...
	{
		$model = ProjectSetting::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='project-setting-form') {
