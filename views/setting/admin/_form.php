...
<?php $headlineLimit = $form->field($model, 'headline_limit', ['template' => '<div class="h6 mt-4 mb-4">'.$model->getAttributeLabel('headline_limit').'</div>{input}{error}{hint}', 'options' => ['tag' => null]])
	->textInput(['type' => 'number', 'min' => '1'])
	->label($model->getAttributeLabel('headline_limit')); ?>

<?php $category = ProjectCategory::getCategory(1);
$headlineCategory = $form->field($model, 'headline_category', ['template' => '<div class="h6 mt-4 mb-4">'.$model->getAttributeLabel('headline_category').'</div>{input}{error}{hint}', 'options' => ['tag' => null]])
...
<?php echo $form->field($model, 'photo_limit', ['template' => '{label}{beginWrapper}<div class="h6 mt-4 mb-4">'.$model->getAttributeLabel('photo_limit').'</div>{input}{error}{hint}{endWrapper}'])
	->textInput(['type' => 'number', 'min' => '1'])
	->label(Yii::t('app', 'Project Image')); ?>

<?php $photoResize = $model::getPhotoResize();
echo $form->field($model, 'photo_resize', ['template' => '{beginWrapper}<div class="h6 mt-4 mb-4">'.$model->getAttributeLabel('photo_resize').'</div>{input}{error}{hint}{endWrapper}', 'horizontalCssClasses' => ['wrapper' => 'col-md-6 col-sm-9 col-xs-12 col-sm-offset-3']])
...
<?php echo $form->field($model, 'photo_file_type', ['template' => '{beginWrapper}<div class="h6 mt-4 mb-4">'.$model->getAttributeLabel('photo_file_type').'</div>{input}{error}{hint}{endWrapper}', 'horizontalCssClasses' => ['wrapper' => 'col-md-3 col-sm-4 col-xs-6 col-sm-offset-3']])
	->textInput()
