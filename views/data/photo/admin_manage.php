...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Add Photo'), 'url' => Url::to(['create']), 'icon' => 'plus-square'],
];
...
array_push($columnData, [
	...
	'buttons' => [
		'view' => function ($url, $model, $key) {
			...
			return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, ['title' => Yii::t('app', 'Detail Photo')]);
		},
		'update' => function ($url, $model, $key) {
			$url = Url::to(ArrayHelper::merge(['update', 'id'=>$model->primaryKey], Yii::$app->request->get()));
			return Html::a('<span class="glyphicon glyphicon-pencil"></span>', $url, ['title' => Yii::t('app', 'Update Photo')]);
		},
